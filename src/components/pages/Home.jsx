  ...
  const floor2data = {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [
          ,
          data.floor_2.zones.d.reserved,
          data.floor_2.zones.e.reserved,
          data.floor_2.zones.h.reserved,
          data.floor_2.zones.i.reserved,
          ,
        ],
  ...
  const floor3data = {
    ...
    datasets: [
      ...
      },
      {
        label: "Reserved",
        data: [
          data.floor_3.zones.j.reserved,
          data.floor_3.zones.k.reserved,
          data.floor_3.zones.l.reserved,
          data.floor_3.zones.m.reserved,
          data.floor_3.zones.n.reserved,
          data.floor_3.zones.q.reserved,
          data.floor_3.zones.r.reserved,
        ],
        backgroundColor: "#2563eb",
        barPercentage: 1.0, // Set the width of the bars to 100% of the available space
        categoryPercentage: 0.8, // Set the spacing between bars to 0%
            ...
            <Link to={"/workstations/rf2"}>
              <div className="flex flex-col place-content-center bg-sky-200 transition ease-in-out delay-150 hover:bg-sky-100 hover:drop-shadow-lg  h-12 p-4 rounded w-28 drop-shadow-md">
                <div className="flex justify-center gap-x-2 font-bold text-sky-700">
                  ...
                  <span>{data.floor_2.reserved}</span>
                </div>
            ...
            <Link to={"workstations/rf3"}>
              <div className="flex flex-col place-content-center bg-sky-200 transition ease-in-out delay-150 hover:bg-sky-100 hover:drop-shadow-lg  h-12 p-4 rounded w-28 drop-shadow-md">
                <div className="flex justify-center gap-2 font-bold text-sky-700">
                  ...
                  <span>{data.floor_3.reserved}</span>
                </div>
                <p className="text-xs mt-0">Reserved</p>
              </div>
            </Link>
          </div>
        </div>
